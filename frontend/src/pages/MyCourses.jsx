        ...
        <div className="min-h-screen bg-gray-50 dark:bg-slate-950">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                ...
                <div className="mb-6 sm:mb-8">
                    <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-2">My Courses</h1>
                    <p className="text-gray-600 dark:text-slate-400">Manage and continue your learning journey</p>
                </div>

                {/* Stats Overview */}
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-6 mb-6 sm:mb-8">
                    <div className="bg-white dark:bg-gradient-to-br dark:from-slate-900 dark:to-slate-800 rounded-xl shadow-sm p-4 sm:p-6 border-l-4 border-primary-500">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-gray-600 dark:text-slate-300 text-xs sm:text-sm font-medium">Total Enrolled</p>
                                <p className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mt-1">{stats.total}</p>
                            </div>
                            <FiBook className="text-primary-500 text-3xl sm:text-4xl" />
                        </div>
                    </div>

                    <div className="bg-white dark:bg-gradient-to-br dark:from-slate-900 dark:to-slate-800 rounded-xl shadow-sm p-4 sm:p-6 border-l-4 border-yellow-500">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-gray-600 dark:text-slate-300 text-xs sm:text-sm font-medium">In Progress</p>
                                <p className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mt-1">{stats.inProgress}</p>
                            </div>
                            <FiClock className="text-yellow-500 text-3xl sm:text-4xl" />
                        </div>
                    </div>

                    <div className="bg-white dark:bg-gradient-to-br dark:from-slate-900 dark:to-slate-800 rounded-xl shadow-sm p-4 sm:p-6 border-l-4 border-green-500">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-gray-600 dark:text-slate-300 text-xs sm:text-sm font-medium">Completed</p>
                                <p className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mt-1">{stats.completed}</p>
                            </div>
                            <FiAward className="text-green-500 text-3xl sm:text-4xl" />
                        </div>
                    </div>

                    <div className="bg-white dark:bg-gradient-to-br dark:from-slate-900 dark:to-slate-800 rounded-xl shadow-sm p-4 sm:p-6 border-l-4 border-gray-400">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-gray-600 dark:text-slate-300 text-xs sm:text-sm font-medium">Not Started</p>
                                <p className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mt-1">{stats.notStarted}</p>
                            </div>
                            <FiBook className="text-gray-400 text-3xl sm:text-4xl" />
                        </div>
                    </div>
                </div>

                {/* Filters and Search */}
                <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm p-4 sm:p-6 mb-6 sm:mb-8">
                    <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
                        ...
                        <div className="flex gap-2 flex-wrap">
                            <button
                                ...
                                className={`px-3 py-1.5 text-sm sm:px-4 sm:py-2 sm:text-base rounded-lg font-medium transition ${filter === 'all'
                            ...
                            <button
                                ...
                                className={`px-3 py-1.5 text-sm sm:px-4 sm:py-2 sm:text-base rounded-lg font-medium transition ${filter === 'in-progress'
                            ...
                            <button
                                ...
                                className={`px-3 py-1.5 text-sm sm:px-4 sm:py-2 sm:text-base rounded-lg font-medium transition ${filter === 'completed'
                            ...
                            <button
                                ...
                                className={`px-3 py-1.5 text-sm sm:px-4 sm:py-2 sm:text-base rounded-lg font-medium transition ${filter === 'not-started'
                ...
                {filteredCourses.length > 0 ? (
                        ...
                        {filteredCourses.map((progress) => (
                            ...
                            >
                                ...
                                <div className="p-4 sm:p-5">
                                    <h3 className="font-semibold text-base sm:text-lg mb-3 line-clamp-2 text-gray-900 dark:text-white group-hover:text-primary-600 dark:group-hover:text-primary-400 transition">
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm p-8 sm:p-12 text-center">
