...
const Courses = () => {
    ...
    return (
        <div className="animate-fade-up min-h-screen bg-slate-50 dark:bg-slate-950 p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-6" style={{ animationDuration: '0.4s' }}>
            {/* Header */}
            <div className="glass-card p-5 sm:p-6">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
                    <div>
                        <h1 className="text-2xl sm:text-3xl font-extrabold gradient-text">Academic Course Catalog</h1>
                    ...
                    <button
                        ...
                        className="btn-glow md:hidden inline-flex items-center gap-2 py-2 px-4 text-xs font-semibold"
                    >
