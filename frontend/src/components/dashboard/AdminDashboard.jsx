...
import { FiUsers, FiBook, FiDollarSign, FiTrendingUp, FiCheckCircle, FiClock, FiX, FiCheck, FiChevronDown, FiUser, FiEdit } from 'react-icons/fi';
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <Link to="/profile/edit" className="flex items-center gap-2 px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white rounded-lg transition font-semibold text-sm">
