        ...
        <div className="min-h-screen bg-gray-50 py-8">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                    ...
                    <Link to="/create-course" className="btn-primary flex items-center gap-2 shadow-lg hover:shadow-xl">
                ...
                <div className="grid md:grid-cols-4 gap-6 mb-8">
                    <div className="bg-white rounded-xl shadow-sm p-6 border-l-4 border-primary-500 hover:shadow-md transition">
                    ...
                    <div className="bg-white rounded-xl shadow-sm p-6 border-l-4 border-secondary-500 hover:shadow-md transition">
                        <div className="flex items-center justify-between">
                            <div>
                            ...
                            <div className="w-14 h-14 bg-secondary-100 rounded-xl flex items-center justify-center">
                                <FiUsers className="text-secondary-600 text-2xl" />
                            </div>
                        </div>
                    </div>
                ...
                {bestCourse && (
                    <div className="bg-gradient-to-r from-primary-600 to-secondary-600 rounded-xl shadow-lg p-8 mb-8 text-white">
                        ...
                        <div className="flex flex-col md:flex-row items-start md:items-center gap-8">
                            <img
                                ...
                                className="w-full md:w-48 h-32 rounded-lg object-cover shadow-lg"
                            />
                ...
                <div className="bg-white rounded-xl shadow-sm overflow-hidden">
                    <div className="p-6 border-b border-gray-200 flex justify-between items-center">
                        ...
                        {courses.length === 0 ? (
                            <Link to="/create-course" className="text-primary-600 font-semibold hover:text-primary-700">
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <Link
                                                        ...
                                                        className="text-secondary-600 hover:text-secondary-700 font-semibold flex items-center gap-1"
                                                        title="Edit Course"
                                                    >
                                                        <FiEdit /> Edit
                                                    </Link>
